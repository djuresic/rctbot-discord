...
class Client:
    ...
    async def latest_client_version(self, client_os="windows", include_zero=False, bit_64=False):
        ...
        arch = (
            {"w": "i686", "m": "universal", "l": "x86-biarch"} if not bit_64 else {"w": "x86_64", "m": "universal-64"}
        )
